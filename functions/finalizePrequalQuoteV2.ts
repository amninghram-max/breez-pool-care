  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f7f8;padding:32px 16px;">
    ...
    try {
      const quoteData = {
        ...
        inputFilterType: prequalAnswers?.filterType,
        inputChlorinatorType: prequalAnswers?.chlorinatorType,
        inputPetsAccess: prequalAnswers?.petsAccess === true,
        inputPetSwimFrequency: prequalAnswers?.petSwimFrequency,
        ...
        outputFrequency: quoteResult.frequencySelectedOrRequired,
        outputFrequencyAutoRequired: quoteResult.frequencyAutoRequired || false,
        configRecordId: quoteResult.configRecordId || null,
