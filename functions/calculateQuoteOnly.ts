...
/**
 * calculateQuoteOnly — unified pricing engine, NO persistence.
 * Used by Demo mode, verifyInspectionQuote, and submitInspection.
 * Returns full quote breakdown without saving any records.
 */

const PRICING_ENGINE_VERSION = 'v2_tokens_risk_frequency';

function runPricingEngine(questionnaireData, settings) {
