...
export default function Onboarding() {
  ...
  const [leadData, setLeadData] = useState({
    ...
    treesOverhead: storedQuoteData?.formData?.treesOverhead || '',
    debrisLevel: storedQuoteData?.formData?.debrisLevel || '',
    ...
    petSwimFrequency: storedQuoteData?.formData?.petSwimFrequency || 'never',
